        ...
        <div className='container pb-20'>
            ...
            <div className='flex items-center flex-wrap justify-between max-w-[572px] mx-auto'>
                <div className='flex gap-3'>
                    ...
                    <div>
                        {
                            Contact?.email?.map((item) => <p key={item?.id} className='text-secondary text-[16px] leading-[30px] font-normal'>{item?.email}</p>)
                        }
                    </div>
                </div>
                ...
                <div className='flex gap-3'>
                    ...
                    <div>
                        {
                            Contact?.number?.map((item) => <p key={item?.id} className='text-secondary text-[16px] leading-[30px] font-normal'>{item?.number}</p>)
                        }
                    </div>
                </div>
            </div>
